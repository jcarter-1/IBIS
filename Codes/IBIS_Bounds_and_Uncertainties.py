...
class IBIS_bounds_and_Uncertainties: 
    ...
    """
    def __init__(self, r08, r28, r48, r08_err, r28_err, r48_err, bounds_filename, results_folder = None):
        self.r08 = r08
        self.r08_err = r08_err
        self.r28 = r28
        self.r28_err = r28_err
    ...
    def Maximum_Age(self):
        if self.ages is not None:
            self.max_age = self.ages[-1] + 2*self.uncertainties[-1]
        return self.max_age
    ...
    def save_bounds(self): 
        if self.Bounds_ is None: 
            self.Get_Bounds()
        path = os.path.join(self.results_folder, self.bounds_filename)
