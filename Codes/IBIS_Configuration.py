...
class IBIS_Configuration_Class: 
    ...
    def load_data(self): 
        ...
        try:
            ...
            print("Data loaded successfully from {}".format(self.filepath))
    ...
    def Get_Measured_Ratios(self):
        ...
        Th230_238U_ratios_err = df['Th_230_r_err'].values/2
        Th232_238U_ratios_err = df['Th_232_r_err'].values/2
        U234_U238_ratios_err = df['U_234_r_err'].values/2
