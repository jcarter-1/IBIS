from ibis_codes_2025 import IBIS_Configuration
from ibis_codes_2025 import IBIS_Bounds_and_Uncertainties
from ibis_codes_2025 import IBIS_Thoth_Exploration
from ibis_codes_2025 import IBIS_MCMC_Initial_Th
from ibis_codes_2025 import IBIS_strat
from ibis_codes_2025 import USeries_Age_Equations
from ibis_codes_2025 import IBIS_strat_Hiatus
import os
import pickle
import numpy as np
...
class IBIS:
    ...
    * Can look at some information
    ...
    def Setup_Bounds_and_Uncertainties(self): 
        if os.path.exists(self.bounds_file_name) and self.Start_from_pickles == True:
    ...
    def Initialize_Thoth(self):
        ...
        if os.path.exists(prior_fname):
            ...
            self.thoth = IBIS_Thoth_Exploration.IBIS_Thoth_Robust(
                ...
                num_samples=5000, file_name=self.kdes_name,
            )
